...
async function checkUserInDatabases() {
  ...
  try {
    ...
    const loginCollection = invoiceDb.collection('users');
    const userInLogin = await loginCollection.findOne({ email: 'deverbishal331@gmail.com' });
    ...
    const userInUsers = await usersCollection.findOne({ email: 'deverbishal331@gmail.com' });
