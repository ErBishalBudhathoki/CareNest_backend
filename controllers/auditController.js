...
class AuditController {
   ...
   */
  static async getEntityAuditHistory(req, res) {
    try {
      ...
      logger.error('Error in getEntityAuditHistory controller', {
        error: error.message,
        stack: error.stack,
   ...
   */
  static async getOrganizationAuditLogs(req, res) {
    try {
      ...
      logger.error('Error in getOrganizationAuditLogs controller', {
        error: error.message,
        stack: error.stack,
  ...
  static async getAuditStatistics(req, res) {
    try {
      ...
      logger.error('Error in getAuditStatistics controller', {
        error: error.message,
        stack: error.stack,
        organizationId: req.params.organizationId
      });
  ...
  static async createAuditLog(req, res) {
    try {
      ...
      logger.error('Error in createAuditLog controller', {
        error: error.message,
        stack: error.stack,
        auditData: req.body
      });
   ...
   */
  static async getAuditMetadata(req, res) {
    try {
      res.status(200).json({
        statusCode: 200,
      ...
      logger.error('Error in getAuditMetadata controller', {
        error: error.message,
        stack: error.stack
      });
      res.status(500).json({
  ...
  static async exportAuditLogs(req, res) {
    try {
      ...
      logger.error('Error in exportAuditLogs controller', {
        error: error.message,
        stack: error.stack,
        organizationId: req.params.organizationId
      });
