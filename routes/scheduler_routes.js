 ...
 */
router.post('/high-frequency',
    logSchedulerExecution('high-frequency'),
    async (req, res) => {
        try {
 ...
 */
router.post('/medium-frequency',
    logSchedulerExecution('medium-frequency'),
    async (req, res) => {
        try {
